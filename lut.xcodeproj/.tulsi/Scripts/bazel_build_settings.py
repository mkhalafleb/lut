...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/mkhalaf/.bazel/bin/bazel',
    '/private/var/tmp/_bazel_mkhalaf/1c3dd69e93e253a3965ba81367e01bf6/execroot/__main__',
    'macos_x86_64',
    {
        'macos_x86_64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/mkhalaf/Library/Application Support/Tulsi/0.20200930.88/Bazel',
